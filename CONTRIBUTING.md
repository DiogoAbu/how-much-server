...
When contributing to this repository, please first discuss the change you wish to make via [issue](https://github.com/DiogoAbu/how-much-server/issues).
...
- Setup dotenv by following the instructions inside `.env.example`

## Issues needing help

Are you out of ideas, but still wanna help? Check out the [help wanted](https://github.com/DiogoAbu/how-much-server/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) or the [good first issue](https://github.com/DiogoAbu/how-much-server/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) labels.
